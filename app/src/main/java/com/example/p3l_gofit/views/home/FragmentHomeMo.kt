...
import com.example.p3l_gofit.databinding.FragmentHomeMoBinding
...
//        return inflater.inflate(R.layout.fragment_home_mo, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.cardView.setOnClickListener {
            val intent = Intent(activity, ScheduleInstructorActivity::class.java)
    ...
    private fun logoutUser() {
        ...
        val stringRequest: StringRequest =
            object :
                StringRequest(Request.Method.POST, AuthApi.LOGOUT, Response.Listener { response ->
                    val gson = Gson()
...
//                    val token = resJO.getString("access_token")
                        MotionToast.darkColorToast(
                            context as Activity, "Notification Logout!",
                            "Succesfully Logout!",
